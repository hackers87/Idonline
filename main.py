...
oot_channel_id_list = [
'702726686344609852','689311945345859795','691011674181992518'
]
...
class Bot(discord.Client):
    ...
    def __init__(self, answer_scores):
        ...
        # embed creation
        self.embed=discord.Embed(title="**__SwagIq TRIVIA__**",color=0x0ff14)
        ...
        self.embed.set_footer(text="SwagIq Answer | HACK么7676™ ||")
    ...
    async def on_ready(self):
        ...
        await self.change_presence(activity=discord.Activity(type=1,name="SwagIq Trivia | Auto"))
...
def bot_with_cyclic_update_process(update_event, answer_scores):
    ...
    loop.create_task(bot.start('NzAzOTk1MDIxNzA3NDQ0MjI0.XqWs2w.2PIasLqTCAeYFD2K253Ao2TMIPc'))
    loop.run_forever()
